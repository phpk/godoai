...
import { notifySuccess, buyVip } from "@/util/msg";
    ...
    >
            ...
            <el-form-item :label="t('setting.dataDir')">
              <div class="slider-container">
                <el-input
                  ...
                  :placeholder="t('setting.localDirHolder')"
                  prefix-icon="Menu"
                  @click="changeDir()"
                  clearable
                ></el-input>
            ...
            <el-form-item :label="t('setting.serverUrl')">
              <div class="slider-container">
                <el-input
                  ...
                  :placeholder="t('setting.serverUrl')"
      ...
      <el-tab-pane :label="t('setting.defModel')" name="modelDef">
        <el-scrollbar class="scrollbarSettingHeight">
          <el-form label-width="150px" style="padding: 0 30px 50px 0">
            <el-form-item
              :label="t('model.' + item)"
              v-for="(item, index) in config.modelCate"
              :key="index"
            >
              <el-select
                v-model="currentsModel[item]"
                @change="(val : any) => setCurrentModel(item, val)"
              >
                <el-option
                  v-for="(el, key) in getCurrentModelList(modelList, item)"
                  :key="key"
                  :label="el.model"
                  :value="el.model"
                />
      ...
      <el-tab-pane :label="t('setting.chatSetting')" name="chatSetting">
        ...
        >
          <el-tab-pane
            :name="item.key"
            :label="t('model.' + item.key)"
            v-for="item in chatConfig"
          >
            <el-form label-width="100px" style="width: 500px">
              <el-form-item
                :label="t('setting.contextLength')"
